...
## Problem Özeti
- Çapraz cihazda geçmiş (exam_history) bazı durumlarda görünmüyor; by_date index bağımlılığı nedeniyle kayıtlar filtrelenemiyor. Çözüm: getAll() ile filtreleme + sıralama, qid fallback.
- Tekrar etiketi semantiği yanlış: İlk çalışma sırasında “1. tekrar” görünmemeli. Etiket yalnızca tamamlanma sonrası başlayan aktif çalışmada (repeats+1) gösterilmeli.
- Döngü gruplama session-bazlıydı; mola yeni satır yapıyordu. İstenen: tamamlanma-bazlı grouping; tüm sorular dokunulana kadar tek satır.
- “Yanlışları Gör” içinde HTML escape referansı hatası vardı; class helper ile düzeltildi.
Tarih: 2025-11-29T19:57:06
